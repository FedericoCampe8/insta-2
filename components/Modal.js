    ...
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        ...
        >
          ...
          >
            <div
              className="inline-block transform overflow-hidden rounded-lg bg-white px-4 pt-5 
              pb-4 text-left align-bottom shadow-xl transition-all 
            ...
            >
              <div>
                ...
                <div className="mt-5 sm:mt-6">
                  ...
                  py-2 text-base font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none
